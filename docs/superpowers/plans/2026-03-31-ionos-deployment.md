...
### Task 7: Update .env.example with Production Notes
...
### Task 9: Supabase Cloud Setup (manual, on supabase.com)
...
### Task 10: Cloudflare DNS Setup (manual, on Cloudflare)
...
### Task 11: Deploy to IONOS Server (manual, via SSH)
...
Replace placeholders with actual values from Task 9 Step 6.
